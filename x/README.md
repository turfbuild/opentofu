...
| `x/lang` | HCL expression evaluation: the `EvalScope`/`Data` seam and the map-shaped `Scope` convenience over it, validation, value marks, repetition meta-argument checks |
